...
let DoctorDashboardService = class DoctorDashboardService {
    ...
    getDoctorDashboard(doctorId) {
        return __awaiter(this, void 0, void 0, function* () {
            const [totalAppointment, consultedAppointment, todaysAppointmentsData] = yield Promise.all([
            ...
            return {
                summary: {
                    ...
                    todaysAppointmentCount: (todaysAppointmentsData === null || todaysAppointmentsData === void 0 ? void 0 : todaysAppointmentsData.count) || 0
                },
                todaysAppointments: (todaysAppointmentsData === null || todaysAppointmentsData === void 0 ? void 0 : todaysAppointmentsData.appointments) || null
            };
        });
    }
};
